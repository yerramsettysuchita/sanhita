...
EXCLUDE: tuple[tuple[str, str], ...] = (
    ...
    # Working material, which is a different kind of private from the four
    # above. Nothing here is a secret, and all of it reads badly out of
    # context: the claims register lists figures marked FALSE that must never
    # be repeated, the notes carry open decisions argued both ways, and the
    # register and the requirement map both carry a real person's name. None
    # of it is needed to run, read or judge the product.
    ("data/**", "internal working notes, drafts and competition material"),
    ("CLAUDE.md", "the assistant's standing instructions for this repository"),
    ("DECK-CORRECTIONS.md", "internal note on which deck figures were wrong"),
    ("GOLD-SET-REVIEW.md", "internal review notes on the gold set"),
    ("themes/**", "the unpacked font archive, 60 MB and unreferenced"),
    ("eval/**", "evaluation output, regenerated by `sanhita eval`"),
)
